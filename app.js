...
// Use concat to combine different arrays
const fruits=['banana', 'Orange'];
const Vegetables=['tomatoes','potatoes', 'Cabbages']
const FruitsAnd_vegetables=fruits.concat(Vegetables);
console.log(FruitsAnd_vegetables)